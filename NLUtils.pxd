...
cdef extern from "netlink/cache.h":
    void nl_cache_dump_filter(nl_cache * cache, nl_dump_params * params, 
                              nl_object * obj)
    ...
    int nl_cache_mngr_alloc(nl_sock * sock, 
                             int protocol, 
                             int flags, 
                             nl_cache_mngr ** result)
    ...
    int nl_cache_mngr_get_fd(nl_cache_mngr * manager)
    int nl_cache_mngr_poll(nl_cache_mngr * manager, int timeout)	    
    int nl_cache_mngr_data_ready(nl_cache_mngr * manager)	
    void nl_cache_mngr_info(nl_cache_mngr * manager, nl_dump_params * params)
    void nl_cache_mngr_free(nl_cache_mngr * manager)	
